    ...
    >
      ...
      <motion.form
        ...
        <div className="sm:col-span-2">
            ...
            <textarea name="message" rows={8} className="w-full p-3 text-sm outline-none rounded-lg border border-gray-300 dark:border-gray-600"
            placeholder="Enter your message" />
        </div>
        <button type="submit" className="w-max flex gap-2 bg-primary text-white text-sm px-4 py-2 rounded-full cursor-pointer
